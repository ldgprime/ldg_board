"""
Django settings for ldg_board project.
...
SECRET_KEY = 'x(vhv07kh@@i9^c&)j#+h$#1@8z1j4h&bs_&kdo=18k5ut-whj'
...
WSGI_APPLICATION = 'ldg_board.wsgi.application'
